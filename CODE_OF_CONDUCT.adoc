...
== Enforcement
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at mailto:abuse%25qualersoft@gmx.net?subject=%5BJMGP%5D%20CoC-violation-report[abuse%qualersoft@gmx.net]. All complaints will be reviewed and investigated promptly and fairly.
